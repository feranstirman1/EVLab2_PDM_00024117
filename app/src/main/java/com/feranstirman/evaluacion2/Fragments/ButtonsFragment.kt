 ...
 * [ButtonsFragment.OnButtonInteractionListener] interface
...
class ButtonsFragment : Fragment() {
    ...
    private var listener: OnButtonInteractionListener? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_buttons, container, false).apply {
            btn_anterior.setOnClickListener {
                listener?.onButtonPrevInteraction()

            }
            btn_siguiente.setOnClickListener {
                listener?.onButtonNextInteraction()
            }
        }
    }
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is OnButtonInteractionListener) {
            listener = context
        } else {
    ...
    interface OnButtonInteractionListener {
        fun onButtonPrevInteraction()
        fun onButtonNextInteraction()
    }
